...
export function PencilIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
...
export function TrashIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
...
export function PaperClipIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
...
export function AlertTriangleIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
...
export function InformationCircleIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
...
export function ChevronLeftIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
...
export function ChevronDownIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} strokeWidth={2} {...props}>
...
export function BarsIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
...
export function ChartBarIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
...
export function CheckCheckIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.75l3.75 3.75 7.5-7.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 12.75l3.75 3.75 7.5-7.5" />
    </svg>
  )
}
...
export function DocumentIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
...
export function BuildingOfficeIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
...
export function MapPinIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
...
export function DocumentTextIcon({ className = 'h-5 w-5', ...props }) {
  return (
    <svg className={className} {...defaultProps} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9zm-6 12.75h7.5m-7.5 3h7.5" />
    </svg>
  )
}
