...
export default function ToastContainer({ toasts, onDismiss }) {
  ...
  return (
    <div aria-live="polite" className="pointer-events-none fixed inset-x-0 top-20 z-[100] flex flex-col items-center gap-3 px-4 sm:inset-x-auto sm:right-4 sm:items-end sm:px-0">
      {toasts.map((toast) => (
